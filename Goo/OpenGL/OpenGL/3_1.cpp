...
int main() {
	...
	Shader myShader = Shader("shader/Chapt3_1.vert", "shader/Chapt3_1.frag");
	myShader.use();
	...
	while (!glfwWindowShouldClose(window)) {
		...
		myShader.setVec3("lights[0].Intensity", glm::vec3(1.0f, 1.0f, 1.0f));
		myShader.setVec4("lights[0].Position", lightViewSpace);

		myShader.setVec3("lights[1].Intensity", glm::vec3(0.0f, 0.0f, 1.0f));
		myShader.setVec4("lights[1].Position", view * glm::vec4(1.0f, 1.0f, 1.0f, 1.0f));

		myShader.setVec3("lights[2].Intensity", glm::vec3(0.0f, 1.0f, 0.0f));
		myShader.setVec4("lights[2].Position", view * glm::vec4(2.0f, -5.0f, 0.0f, 1.0f));

		myShader.setVec3("lights[3].Intensity", glm::vec3(1.0f, 0.0f, 1.0f));
		myShader.setVec4("lights[3].Position", view * glm::vec4(-2.0f, 5.0f, 0.0f, 1.0f));

		myShader.setVec3("lights[4].Intensity", glm::vec3(1.0f, 0.0f, 0.0f));
		myShader.setVec4("lights[4].Position", view * glm::vec4(3.0f, 3.0f, -3.0f, 1.0f));

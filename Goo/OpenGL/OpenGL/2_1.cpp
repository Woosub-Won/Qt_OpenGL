...
int main() {
	...
	Shader myShader = Shader("shader/Chapt2_1.vert", "shader/Chapt2_1.frag");
	myShader.use();
	...
	while (!glfwWindowShouldClose(window)) {
		...
		myShader.setVec3("Ld", glm::vec3(1.0f, 1.0f, 1.0f));
		myShader.setVec4("LightPosition", glm::vec4(1.2f, 1.0f, 2.0f, 1.0f));
		myShader.setVec3("Kd", glm::vec3(0.7f, 0.7f, 0.3f));

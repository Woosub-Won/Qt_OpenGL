...
int main() {
	...
	Shader myShader = Shader("shader/Chapt3_5.vert", "shader/Chapt3_5.frag");
	myShader.use();
	...
	while (!glfwWindowShouldClose(window)) {
		...
		myShader.setVec3("Spot.intensity", glm::vec3(1.0f, 1.0f, 1.0f));
		myShader.setVec4("Spot.position", lightViewSpace);
		//myShader.setVec4("light.Position", glm::vec4(lightPos, 1.0f));
		myShader.setVec3("Spot.direction", glm::vec3(/*view**/glm::vec4(0.0f, 0.0f, -1.0f, 1.0f)));
		myShader.setFloat("Spot.exponent", 128.0f);
		myShader.setFloat("Spot.cutoff", 60.0f);
